...
public class AsyncDemo_数据服务_5_11_银行卡识别 {

    private AsyncApiClient_数据服务_5_11_银行卡识别 asyncClient = null;

    public AsyncDemo_数据服务_5_11_银行卡识别() {
        this.asyncClient = AsyncApiClient_数据服务_5_11_银行卡识别.newBuilder()
    ...
    public void 印刷文字识别_银行卡识别Demo(byte[] body) {
        asyncClient.印刷文字识别_银行卡识别(body, new ApiCallBack() {
            @Override
