...
public class ThreadPool5
{
	...
	private static final int nThreads = 5;// 线程池中最大线程数,可以读取配置文件优化
	...
	public static void main(String[] args)
	{
		...
		ConcurrentLinkedQueue<UserInfo> clq = new ConcurrentLinkedQueue<>();// 队列
		...
		for (int i = 0; i < number; i++)
		{
			...
			final Future<String> future = fixedThreadPool.submit(new MyCallable5(userInfo, cdl, clq));
